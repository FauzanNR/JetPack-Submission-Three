...
class MovieFavoriteViewModelTest {
    ...
    lateinit var viewModelTest: FakeMovieFavoriteViewModelForTest
    ...
    fun setUp() {
        ...
        viewModelTest = FakeMovieFavoriteViewModelForTest(dataRepository)
    }
    ...
    fun selectData() {
        ...
        Mockito.verify(dataRepository, Mockito.atLeastOnce()).getLocalDataMovieFav()
